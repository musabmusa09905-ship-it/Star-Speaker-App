...
-- Role-aware privacy-preserving consistency board.
-- Admins receive the full safe school list.
-- Teachers receive the safe Top 10 plus safe rows for their assigned students.
-- Students receive the safe Top 10 plus their own private position.
