...
export function MobileDrawer({ activeTab, isOpen, navItems, user, onClose }) {
  ...
  return (
    <>
      <button
        ...
        onClick={onClose}
      />
      <aside className={`mobile-slide-menu mobile-drawer ${isOpen ? "is-open" : ""}`} aria-label="Full mobile navigation" aria-hidden={!isOpen}>
