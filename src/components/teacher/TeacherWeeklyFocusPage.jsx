        ...
        {students.map((student) => {
          ...
          return (
            ...
            >
              ...
              <em>
                {student.learningProfile?.level ? formatLevelForStaff(student.learningProfile.level) : "Level not set"}
  ...
  if (profile?.role === "admin") {
    return (
      <div className="teacher-weekly-focus-page">
        <Header user={user} title="Weekly Focus" subtitle="Set focused speaking goals for the week." />
        <TeacherWeeklyFocusState
          title="Weekly focus is handled by teacher accounts."
          message="Use a teacher account linked to students to set weekly speaking focus."
        />
      </div>
    );
  }
